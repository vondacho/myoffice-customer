...
public final class FolderRestTestObjectFactory {

    public static final Folder FOLDER_TEST_OBJECT = createDefaultFolder();

    private static final String DEFAULT_NAME = "John Doe";
    private static final String DEFAULT_NOTES = "He is very dangerous.";

    private static Folder createDefaultFolder() {
